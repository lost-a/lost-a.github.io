 ...
 function Freeroll() {
     ...
     useEffect(() => {
         ...
         try {
             let data=[];
             let m= new Map();
             const res = await axios.get(` https://pokerfilt.com/get_all/Freeroll/`);
             ...
             <div className="row mt-5">
                 ...
                 <div className="row mt-5">
                        ...
                        <Link to="/Satellite" className="btn btn-primary btn block ">Satellites</Link>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                        <Link to="/freeroll" className="btn btn-warning btn block ml-1">FreeRoll</Link>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
        ...
        <div  class="form-container" id='formg' name="google-sheet">
            <div className="form-row p-0">
                ...
                <div className="form-row" style={{marginTop:"-15px"}}>
                    <div className=" form-group col-lg-4 col-md-4 col-sm-4 col-4" >
